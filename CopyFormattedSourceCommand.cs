...
namespace CopyFormattedSource
{
    ...
    internal sealed class CopyFormattedSourceCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("bf8eabfb-33c8-4f34-bdf8-cf53ccf489c2");
        ...
        {
            // Switch to the main thread - the call to AddCommand in CopyFormattedSourceComman's constructor requires
            // the UI thread.
